...
public class DataGenerator {
	...
	public HashSet<String> getGroupNames(int quantity) {
	...
	public HashSet<String> getCourseNames(int quantity) throws IOException {
		...
		final ArrayList<String> courseNamesPool = new ArrayList<String>(
				fileLoader.load(namesUrl).stream().collect(Collectors.toList()));
	...
	private char getOneRandomFrom(String input) {
		if (input == null) {
			throw new NullPointerException("ERROR: Null Pointer Argument.");
		}
