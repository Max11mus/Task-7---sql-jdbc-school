...
class SchoolDAOTest extends DataSourceBasedDBTestCase {
    ...
    @Test
    void insertGroups_AfterInsert_DataMustBeSameAsExpected() throws Exception {
    ...
    @Test
    void insertStudents_AfterInsert_DataMustBeSameAsExpected() throws Exception {
    ...
    @Test
    void getAllStudents_AfterReading_DataMustBeSameAsExpected() throws SQLException, Exception {
